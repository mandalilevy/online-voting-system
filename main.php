...
if (isset($_SESSION['dean'])) {
                  echo '<a style="color: white; font-family:Verdana; font-weight:bolder;" class="nav-link"> Welcome: '.$_SESSION['dean'].'</a>';
                    }
...
<ul class="navbar-nav  mt-lg-0 mx-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 ml-auto">
 	...
 	<li class="nav-item">
   <?php 
echo '<a class="nav-link ml-auto" style="color: white; font-weight:bolder; font-family:Verdana"  href="deanlogout.php?logout">Sign Out <i class="fa fa-sign-out" aria-hidden="true"></i></a>';
  ?>
   </li>
 </ul>
 </div> 
...
<div class="container pt-sm-4">
  <div class="jumbotron ">
    ...
    <center>
       <button class="btn btn-group-sm btn-block w-25 "data-toggle="modal" data-target="#post" style="font-weight: bolder;color: purple">ADD POSTS</button>
          <button class="btn btn-group-sm btn-block w-25" style=""><a href="candadd.php"style="font-weight: bolder;color: purple;text-decoration: none;">ADD CANDIDATES</a> </button>
          <button class="btn btn-group-sm btn-block w-25" >
          <a href="realtime_results.php" style="font-weight: bolder;color: purple;text-decoration: none;">VIEW  RESULTS</a> </button>
           <button class="btn btn-group-sm btn-block w-50" >
          <a href="generalreport.php" style="font-weight: bolder;color: purple;text-decoration: none;">GENERAL ELECTIONS REPORT</a> </button>
           <button class="btn btn-group-sm btn-block w-50" >
          <a href="presdentialreport.php" style="font-weight: bolder;color: purple;text-decoration: none;">PRESDENTIAL ELECTIONS REPORT</a> </button>
          </center>
     </div>
    <style>
      td{

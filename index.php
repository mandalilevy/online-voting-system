...
<?php 
              ...
              <button class="btn btn-primary text-uppercase" name="submit" type="submit">Login</button>
             <div style="float:right;"><a href="registration.php" style="text-decoration: underline;color: purple">Register Here</a> </div> 
            </form>
          </div>
        </div>
      </div>

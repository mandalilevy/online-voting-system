...
<div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5 mt-4 p-2 rounded bg-white">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: purple">PRESDENTIAL RESULTS</h5>
             <?php 
...
return $stmt->rowcount();
 ...
 ?> 
    ...
    <input type="text" class="form-control" name="results" readonly="readonly"  value="<?php echo rowcount($connect,"Select * from president where candidate='".$_POST['sub_category_item']."'") ?>">
<?php } ?>
...
<script type="text/javascript">
    function getOrders() {
        ...
        ajax.open("GET", "president.php", true);
        ajax.send();
